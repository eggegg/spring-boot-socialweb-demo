...
// 2、数据源配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/socialweb?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true");
...
// 3、包配置
        ...
        pc.setParent("com.imooc.socialweb");
        pc.setEntity("pojo");
        pc.setMapper("mapper");
